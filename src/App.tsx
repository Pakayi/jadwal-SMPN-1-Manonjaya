            ...
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm text-gray-500 leading-relaxed">
                  Tindakan ini akan menimpa seluruh data input aktif Anda dengan data master demo lengkap SMPN 1 Manonjaya (56 Guru, 33 Kelas/Rombel, dan 462 Kontrak Beban Mengajar).
                </p>
              </div>
            </div>
